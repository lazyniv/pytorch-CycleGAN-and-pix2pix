"""This package includes all the modules related to datasets loading and preprocessing
 ...
 To add a custom datasets class called 'dummy', you need to add a file called 'dummy_dataset.py' and define a subclass 'DummyDataset' inherited from BaseDataset.
...
def find_dataset_using_name(dataset_name):
    ...
    if dataset is None:
        raise NotImplementedError(
            "In %s.py, there should be a subclass of BaseDataset with class name that matches %s "
